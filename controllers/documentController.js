...
router.get('/showOrEdit', (req, res) => {
    res.render('document/showOrEdit');
});

router.get('/2559', (req, res) => {
    res.render('document/2559');
});

router.get('/2560', (req, res) => {
    res.render('document/2560');
});

router.get('/2561', (req, res) => {
    res.render('document/2561');
});

router.get('/2562', (req, res) => {
    res.render('document/2562');
});

router.get('/download', (req, res) => {
    res.render('document/download');
});
// call update 
router.post('/', (req, res) => {
...
// list see all 2562
router.get('/list2562', (req, res) => {
    Document.find( { "date": { "$regex": "/2562", "$options": "i" } }, function (err, docs) {
        if (!err) {
            res.render("document/list", {
                viewTitle: "ข้อมูลการเข้าใช้สระประจำปี 2562",
                list: docs
            });
        }
        else {
...
router.get('/list37', (req, res) => {
    test = 'list37'
    Document.find( { "date": { "$regex": "/1/2562", "$options": "i" } }, function (err, docs) {
        if (!err) {
            res.render("document/list", {
                viewTitle: "ข้อมูลประจำเดือน มกราคม 2562",
                list: docs
            });
        }
        else {
...
router.get('/list38', (req, res) => {
    test = 'list38'
    Document.find( { "date": { "$regex": "/2/2562", "$options": "i" } }, function (err, docs) {
        if (!err) {
            res.render("document/list", {
                viewTitle: "ข้อมูลประจำเดือน กุมภาพันธ์ 2562",
                list: docs
            });
        }
        else {
...
router.get('/list39', (req, res) => {
    test = 'list39'
    Document.find( { "date": { "$regex": "/3/2562", "$options": "i" } }, function (err, docs) {
        if (!err) {
            res.render("document/list", {
                viewTitle: "ข้อมูลประจำเดือน มีนาคม 2562",
                list: docs
            });
        }
        else {
...
//เมษายน
router.get('/list40', (req, res) => {
    test = 'list40'
    Document.find( { "date": { "$regex": "/4/2562", "$options": "i" } }, function (err, docs) {
        if (!err) {
            res.render("document/list", {
                viewTitle: "ข้อมูลประจำเดือน เมษายน 2562",
                list: docs
            });
        }
        else {
...
//พฤษภาคม 
router.get('/list41', (req, res) => {
    test = 'list41'
    Document.find( { "date": { "$regex": "/5/2562", "$options": "i" } }, function (err, docs) {
        if (!err) {
            res.render("document/list", {
                viewTitle: "ข้อมูลประจำเดือน พฤษภาคม 2562",
                list: docs
            });
        }
        else {
...
//มิถุนายน
router.get('/list42', (req, res) => {
    test = 'list42'
    Document.find( { "date": { "$regex": "/6/2562", "$options": "i" } }, function (err, docs) {
        if (!err) {
            res.render("document/list", {
                viewTitle: "ข้อมูลประจำเดือน มิถุนายน 2562",
                list: docs
            });
        }
        else {
...
//กรกฎาคม
router.get('/list43', (req, res) => {
    test = 'list43'
    Document.find( { "date": { "$regex": "/7/2562", "$options": "i" } }, function (err, docs) {
        if (!err) {
            res.render("document/list", {
                viewTitle: "ข้อมูลประจำเดือน กรกฎาคม 2562",
                list: docs
            });
        }
        else {
...
//สิงหาคม
router.get('/list44', (req, res) => {
    test = 'list44'
    Document.find( { "date": { "$regex": "/8/2562", "$options": "i" } }, function (err, docs) {
        if (!err) {
            res.render("document/list", {
                viewTitle: "ข้อมูลประจำเดือน สิงหาคม 2562",
                list: docs
            });
        }
        else {
...
//กันยายน
router.get('/list45', (req, res) => {
    test = 'list45'
    Document.find( { "date": { "$regex": "/9/2562", "$options": "i" } }, function (err, docs) {
        if (!err) {
            res.render("document/list", {
                viewTitle: "ข้อมูลประจำเดือน กันยายน 2562",
                list: docs
            });
        }
        else {
...
//ตุลาคม
router.get('/list46', (req, res) => {
    test = 'list46'
    Document.find( { "date": { "$regex": "/10/2562", "$options": "i" } }, function (err, docs) {
        if (!err) {
            res.render("document/list", {
                viewTitle: "ข้อมูลประจำเดือน ตุลาคม 2562",
                list: docs
            });
        }
        else {
...
//พฤษจิกายน
router.get('/list47', (req, res) => {
    test = 'list47'
    Document.find( { "date": { "$regex": "/11/2562", "$options": "i" } }, function (err, docs) {
        if (!err) {
            res.render("document/list", {
                viewTitle: "ข้อมูลประจำเดือน พฤษจิกายน 2562",
                list: docs
            });
        }
        else {
...
//ธันวาคม
router.get('/list48', (req, res) => {
    test = 'list48'
    Document.find( { "date": { "$regex": "/12/2562", "$options": "i" } }, function (err, docs) {
        if (!err) {
            res.render("document/list", {
                viewTitle: "ข้อมูลประจำเดือน ธันวาคม 2562",
                list: docs
            });
        }
        else {
